        ...
        <header class="masthead">
            <div class="container">
                <div class="row">
                    ...
                    <div class="masthead-heading text-uppercase">Education & Training</div>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Education & Training</h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">SHAF (Holiday Activities & Food)</div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <a class="portfolio-link" data-bs-toggle="modal" href="#workshopModal2">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Parole Programmes</div>
                    ...
                    <a class="portfolio-link" data-bs-toggle="modal" href="#workshopModal3">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">SEND</div>
                                <div class="portfolio-caption-subheading text-muted">
                    ...
                    <a class="portfolio-link" data-bs-toggle="modal" href="#workshopModal4">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Nature-based learning</div>
                                <div class="portfolio-caption-subheading text-muted">
                    ...
                    <a class="portfolio-link" data-bs-toggle="modal" href="#workshopModal4">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Teachger CPD</div>
                                <div class="portfolio-caption-subheading text-muted">
                                Learn how to design and make a durable garden kneeler</div>
                            </div>
                        </div>
                    ...
                    <a class="portfolio-link" data-bs-toggle="modal" href="#workshopModal4">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Sustainability Projects</div>
                                <div class="portfolio-caption-subheading text-muted">
                                Learn how to design and make a durable garden kneeler</div>
                            </div>
                        </div>
